        ...
        async onClick() {
            ...
            try {
                ...
                this.showPopup('QuotationPopUpAlert', {
                    ...
                    body: this.env._t("Não foi possível acessar o servidor. Verifique se você tem uma conexão ativa com a Internet, se o endereço do servidor inserido é válido e se o servidor está online."),
                })
                return;
            }
            const {
            ...
            if (confirmed) {
                if (!this.currentOrder.export_as_JSON().lines.length) {
                    this.showPopup('QuotationPopUpAlert', {
                        ...
                        body: this.env._t('Pelo menos um produto é necessário para criar a cotação'),
                    })
                    return;
                }
                if (print) {
