    ...
    def action_send_whatsapp(self):
        if self.note and self.mobile_number:
            if self.res_model == 'sale.order':
                common_message = 'Acesse após o Documento de Pedido de Venda.'
            elif self.res_model == 'account.move':
                common_message = 'Acesse o seguinte Documento de Fatura.'
            elif self.res_model == 'purchase.order':
                common_message = 'Acesse seguindo o Documento de Compra.'
            else:
                common_message = 'Você pode acessar o seguinte Documento.'
