    ...
    def invoice_whatsapp(self):
        ...
        if not record_phone[0] == "+":
            ...
            return {'type': 'ir.actions.act_window',
                    ...
                    'view_type': 'form',
                    'context': {
                        'default_template_id': self.env.ref('hm_odoo_whatsapp.whatsapp_invoice_template').id},
                    }
        ...
        if cust_check:
            ...
            for each in invoice_order_ids:
                ...
                for id in each.invoice_line_ids:
                    prods = prods + "*" + "Produto: " + str(id.product_id.name) + ", Qtd: " + str(id.quantity) + "* \n"
            ...
            for every in product_all:
                custom_msg = custom_msg + "Seu pedido " + "*" + invoice_nums[
