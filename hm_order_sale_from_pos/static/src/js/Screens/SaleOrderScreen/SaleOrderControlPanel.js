odoo.define('pos_sale.SaleOrderControlPanel', function (require) {
    'use strict';
     ...
     * @emits search
     */
    class SaleOrderControlPanel extends PosComponent {
        constructor() {
            super(...arguments);
    ...
    SaleOrderControlPanel.template = 'SaleOrderControlPanel';

    Registries.Component.add(SaleOrderControlPanel);

    return SaleOrderControlPanel;
});
