odoo.define('hm_create_so_from_pos.HmCustomClientDetailsEdit', function(require) {
    'use strict';
    ...
    class HmCustomClientDetailsEdit extends PosComponent {
        constructor() {
            super(...arguments);
    ...
    HmCustomClientDetailsEdit.template = 'HmCustomClientDetailsEdit';

    Registries.Component.add(HmCustomClientDetailsEdit);

    return HmCustomClientDetailsEdit;
});
