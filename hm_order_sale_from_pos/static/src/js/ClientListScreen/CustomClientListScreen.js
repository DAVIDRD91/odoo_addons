odoo.define('hm_create_so_from_pos.HmCustomClientListScreen', function(require) {
    'use strict';
     ...
     */
    class HmCustomClientListScreen extends PosComponent {
        constructor() {
            super(...arguments);
    ...
    HmCustomClientListScreen.template = 'HmCustomClientListScreen';

    Registries.Component.add(HmCustomClientListScreen);

    return HmCustomClientListScreen;
});
